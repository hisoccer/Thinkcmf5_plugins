...
class SmsDemo
{
     ...
     * @return stdClass
     */
    public static function sendSms($mobile,$code,$accessKeyId,$accessKeySecret,$SignName,$template_id,$expire_minute) {
...
// 调用示例：
function sendsms($mobile,$code,$accessKeyId,$accessKeySecret,$SignName,$template_id,$expire_minute){
    $response = SmsDemo::sendSms($mobile,$code,$accessKeyId,$accessKeySecret,$SignName,$template_id,$expire_minute);
    return $response;
}
/*
